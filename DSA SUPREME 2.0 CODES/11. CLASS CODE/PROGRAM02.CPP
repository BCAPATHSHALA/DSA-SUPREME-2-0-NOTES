// Program 02: Find first occurrence of a number in sorted array
#include<iostream>
#include<vector>
using namespace std;
...
int main(){
    ...
    int finalAns = findFirstOccurence(arr,target);

    if(finalAns!=-1){
        cout<<"First occurence of target is at index "<<finalAns<<endl;
    }
    else{
        cout<<finalAns<<endl;
    }
...
OUTPUT: First occurence of target is at index 2

EXAMPLE 02:
INPUT: arr[10,20,30,30,30,30,40,50], target=10
OUTPUT: First occurence of target is at index 0

EXAMPLE 03:
INPUT: arr[10,20,30,30,30,30,40,50], target=50
OUTPUT: First occurence of target is at index 7
